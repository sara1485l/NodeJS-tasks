...
console.log(trimmedPhrase.toUpperCase());
console.log(trimmedPhrase.toLowerCase());

// 22) Replace "Fun" with "Awesome" and log the new phrase. (use phrase variable)
console.log(trimmedPhrase.replace("Fun","Awesome"));
...
console.log(`${classroom.batches[0].students[0].name
} - ${classroom.batches[0].students[0].scores.at(-1)
} - ${classroom.batches[0].students[0].name.toLowerCase().includes("a")}`);

console.log(`${classroom.batches[0].students[1].name
} - ${classroom.batches[0].students[1].scores.at(-1)
